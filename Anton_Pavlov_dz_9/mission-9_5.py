...
class Pen(Stationery):
    ...
    def draw(self) -> None:
        return print(f'Pen: приступил к отрисовке объекта "{self.title}"')
...
class Pencil(Stationery):
    ...
    def draw(self) -> None:
        ...
        print(f'Pencil: приступил к отрисовке объекта "{self.title}"')


class Handle(Stationery):

    def draw(self) -> None:
        return print(f'Handle: приступил к отрисовке объекта "{self.title}"')
